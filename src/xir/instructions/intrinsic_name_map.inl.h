...
luisa::string to_string(IntrinsicOp op) noexcept {
    switch (op) {
        ...
        case IntrinsicOp::UNARY_LOGIC_NOT: return "unary_logic_not";
        ...
        case IntrinsicOp::BINARY_LOGIC_AND: return "binary_logic_and";
        case IntrinsicOp::BINARY_LOGIC_OR: return "binary_logic_or";
        ...
        case IntrinsicOp::TEXTURE2D_READ: return "texture2d_read";
        case IntrinsicOp::TEXTURE2D_WRITE: return "texture2d_write";
        case IntrinsicOp::TEXTURE2D_SIZE: return "texture2d_size";
        ...
        case IntrinsicOp::TEXTURE3D_READ: return "texture3d_read";
        case IntrinsicOp::TEXTURE3D_WRITE: return "texture3d_write";
        case IntrinsicOp::TEXTURE3D_SIZE: return "texture3d_size";
        ...
        case IntrinsicOp::AUTODIFF_REQUIRES_GRADIENT: return "autodiff_requires_gradient";
        case IntrinsicOp::AUTODIFF_GRADIENT: return "autodiff_gradient";
        case IntrinsicOp::AUTODIFF_GRADIENT_MARKER: return "autodiff_gradient_marker";
        case IntrinsicOp::AUTODIFF_ACCUMULATE_GRADIENT: return "autodiff_accumulate_gradient";
        case IntrinsicOp::AUTODIFF_BACKWARD: return "autodiff_backward";
        case IntrinsicOp::AUTODIFF_DETACH: return "autodiff_detach";
...
IntrinsicOp intrinsic_op_from_string(luisa::string_view name) noexcept {
    static const luisa::unordered_map<luisa::string, IntrinsicOp> m{
        ...
        {"unary_logic_not", IntrinsicOp::UNARY_LOGIC_NOT},
        ...
        {"binary_logic_and", IntrinsicOp::BINARY_LOGIC_AND},
        {"binary_logic_or", IntrinsicOp::BINARY_LOGIC_OR},
        ...
        {"texture2d_read", IntrinsicOp::TEXTURE2D_READ},
        {"texture2d_write", IntrinsicOp::TEXTURE2D_WRITE},
        {"texture2d_size", IntrinsicOp::TEXTURE2D_SIZE},
        ...
        {"texture3d_read", IntrinsicOp::TEXTURE3D_READ},
        {"texture3d_write", IntrinsicOp::TEXTURE3D_WRITE},
        {"texture3d_size", IntrinsicOp::TEXTURE3D_SIZE},
        ...
        {"bindless_buffer_device_address", IntrinsicOp::BINDLESS_BUFFER_DEVICE_ADDRESS},
        ...
        {"autodiff_requires_gradient", IntrinsicOp::AUTODIFF_REQUIRES_GRADIENT},
        {"autodiff_gradient", IntrinsicOp::AUTODIFF_GRADIENT},
        {"autodiff_gradient_marker", IntrinsicOp::AUTODIFF_GRADIENT_MARKER},
        {"autodiff_accumulate_gradient", IntrinsicOp::AUTODIFF_ACCUMULATE_GRADIENT},
        {"autodiff_backward", IntrinsicOp::AUTODIFF_BACKWARD},
        {"autodiff_detach", IntrinsicOp::AUTODIFF_DETACH},
