...
luisa::string_view to_string(IntrinsicOp op) noexcept {
    ...
    switch (op) {
        ...
        case IntrinsicOp::UNARY_PLUS: return "unary_plus"sv;
        case IntrinsicOp::UNARY_MINUS: return "unary_minus"sv;
        case IntrinsicOp::UNARY_LOGIC_NOT: return "unary_logic_not"sv;
        case IntrinsicOp::UNARY_BIT_NOT: return "unary_bit_not"sv;
        case IntrinsicOp::BINARY_ADD: return "binary_add"sv;
        case IntrinsicOp::BINARY_SUB: return "binary_sub"sv;
        case IntrinsicOp::BINARY_MUL: return "binary_mul"sv;
        case IntrinsicOp::BINARY_DIV: return "binary_div"sv;
        case IntrinsicOp::BINARY_MOD: return "binary_mod"sv;
        case IntrinsicOp::BINARY_LOGIC_AND: return "binary_logic_and"sv;
        case IntrinsicOp::BINARY_LOGIC_OR: return "binary_logic_or"sv;
        case IntrinsicOp::BINARY_BIT_AND: return "binary_bit_and"sv;
        case IntrinsicOp::BINARY_BIT_OR: return "binary_bit_or"sv;
        case IntrinsicOp::BINARY_BIT_XOR: return "binary_bit_xor"sv;
        case IntrinsicOp::BINARY_SHIFT_LEFT: return "binary_shift_left"sv;
        case IntrinsicOp::BINARY_SHIFT_RIGHT: return "binary_shift_right"sv;
        case IntrinsicOp::BINARY_ROTATE_LEFT: return "binary_rotate_left"sv;
        case IntrinsicOp::BINARY_ROTATE_RIGHT: return "binary_rotate_right"sv;
        case IntrinsicOp::BINARY_LESS: return "binary_less"sv;
        case IntrinsicOp::BINARY_GREATER: return "binary_greater"sv;
        case IntrinsicOp::BINARY_LESS_EQUAL: return "binary_less_equal"sv;
        case IntrinsicOp::BINARY_GREATER_EQUAL: return "binary_greater_equal"sv;
        case IntrinsicOp::BINARY_EQUAL: return "binary_equal"sv;
        case IntrinsicOp::BINARY_NOT_EQUAL: return "binary_not_equal"sv;
        case IntrinsicOp::ALL: return "all"sv;
        case IntrinsicOp::ANY: return "any"sv;
        case IntrinsicOp::SELECT: return "select"sv;
        case IntrinsicOp::CLAMP: return "clamp"sv;
        case IntrinsicOp::SATURATE: return "saturate"sv;
        case IntrinsicOp::LERP: return "lerp"sv;
        case IntrinsicOp::SMOOTHSTEP: return "smoothstep"sv;
        case IntrinsicOp::STEP: return "step"sv;
        case IntrinsicOp::ABS: return "abs"sv;
        case IntrinsicOp::MIN: return "min"sv;
        case IntrinsicOp::MAX: return "max"sv;
        case IntrinsicOp::CLZ: return "clz"sv;
        case IntrinsicOp::CTZ: return "ctz"sv;
        case IntrinsicOp::POPCOUNT: return "popcount"sv;
        case IntrinsicOp::REVERSE: return "reverse"sv;
        case IntrinsicOp::ISINF: return "isinf"sv;
        case IntrinsicOp::ISNAN: return "isnan"sv;
        case IntrinsicOp::ACOS: return "acos"sv;
        case IntrinsicOp::ACOSH: return "acosh"sv;
        case IntrinsicOp::ASIN: return "asin"sv;
        case IntrinsicOp::ASINH: return "asinh"sv;
        case IntrinsicOp::ATAN: return "atan"sv;
        case IntrinsicOp::ATAN2: return "atan2"sv;
        case IntrinsicOp::ATANH: return "atanh"sv;
        case IntrinsicOp::COS: return "cos"sv;
        case IntrinsicOp::COSH: return "cosh"sv;
        case IntrinsicOp::SIN: return "sin"sv;
        case IntrinsicOp::SINH: return "sinh"sv;
        case IntrinsicOp::TAN: return "tan"sv;
        case IntrinsicOp::TANH: return "tanh"sv;
        case IntrinsicOp::EXP: return "exp"sv;
        case IntrinsicOp::EXP2: return "exp2"sv;
        case IntrinsicOp::EXP10: return "exp10"sv;
        case IntrinsicOp::LOG: return "log"sv;
        case IntrinsicOp::LOG2: return "log2"sv;
        case IntrinsicOp::LOG10: return "log10"sv;
        case IntrinsicOp::POW: return "pow"sv;
        case IntrinsicOp::POW_INT: return "pow_int"sv;
        case IntrinsicOp::SQRT: return "sqrt"sv;
        case IntrinsicOp::RSQRT: return "rsqrt"sv;
        case IntrinsicOp::CEIL: return "ceil"sv;
        case IntrinsicOp::FLOOR: return "floor"sv;
        case IntrinsicOp::FRACT: return "fract"sv;
        case IntrinsicOp::TRUNC: return "trunc"sv;
        case IntrinsicOp::ROUND: return "round"sv;
        case IntrinsicOp::RINT: return "rint"sv;
        case IntrinsicOp::FMA: return "fma"sv;
        case IntrinsicOp::COPYSIGN: return "copysign"sv;
        case IntrinsicOp::CROSS: return "cross"sv;
        case IntrinsicOp::DOT: return "dot"sv;
        case IntrinsicOp::LENGTH: return "length"sv;
        case IntrinsicOp::LENGTH_SQUARED: return "length_squared"sv;
        case IntrinsicOp::NORMALIZE: return "normalize"sv;
        case IntrinsicOp::FACEFORWARD: return "faceforward"sv;
        case IntrinsicOp::REFLECT: return "reflect"sv;
        case IntrinsicOp::REDUCE_SUM: return "reduce_sum"sv;
        case IntrinsicOp::REDUCE_PRODUCT: return "reduce_product"sv;
        case IntrinsicOp::REDUCE_MIN: return "reduce_min"sv;
        case IntrinsicOp::REDUCE_MAX: return "reduce_max"sv;
        case IntrinsicOp::OUTER_PRODUCT: return "outer_product"sv;
        case IntrinsicOp::MATRIX_COMP_NEG: return "matrix_comp_neg"sv;
        case IntrinsicOp::MATRIX_COMP_ADD: return "matrix_comp_add"sv;
        case IntrinsicOp::MATRIX_COMP_SUB: return "matrix_comp_sub"sv;
        case IntrinsicOp::MATRIX_COMP_MUL: return "matrix_comp_mul"sv;
        case IntrinsicOp::MATRIX_COMP_DIV: return "matrix_comp_div"sv;
        case IntrinsicOp::MATRIX_LINALG_MUL: return "matrix_linalg_mul"sv;
        case IntrinsicOp::MATRIX_DETERMINANT: return "matrix_determinant"sv;
        case IntrinsicOp::MATRIX_TRANSPOSE: return "matrix_transpose"sv;
        case IntrinsicOp::MATRIX_INVERSE: return "matrix_inverse"sv;
        case IntrinsicOp::AGGREGATE: return "aggregate"sv;
        case IntrinsicOp::SHUFFLE: return "shuffle"sv;
        case IntrinsicOp::INSERT: return "insert"sv;
        case IntrinsicOp::EXTRACT: return "extract"sv;
...
IntrinsicOp intrinsic_op_from_string(luisa::string_view name) noexcept {
    ...
    static const luisa::unordered_map<luisa::string_view, IntrinsicOp> m{
        ...
        {"unary_plus"sv, IntrinsicOp::UNARY_PLUS},
        {"unary_minus"sv, IntrinsicOp::UNARY_MINUS},
        {"unary_logic_not"sv, IntrinsicOp::UNARY_LOGIC_NOT},
        {"unary_bit_not"sv, IntrinsicOp::UNARY_BIT_NOT},
        {"binary_add"sv, IntrinsicOp::BINARY_ADD},
        {"binary_sub"sv, IntrinsicOp::BINARY_SUB},
        {"binary_mul"sv, IntrinsicOp::BINARY_MUL},
        {"binary_div"sv, IntrinsicOp::BINARY_DIV},
        {"binary_mod"sv, IntrinsicOp::BINARY_MOD},
        {"binary_logic_and"sv, IntrinsicOp::BINARY_LOGIC_AND},
        {"binary_logic_or"sv, IntrinsicOp::BINARY_LOGIC_OR},
        {"binary_bit_and"sv, IntrinsicOp::BINARY_BIT_AND},
        {"binary_bit_or"sv, IntrinsicOp::BINARY_BIT_OR},
        {"binary_bit_xor"sv, IntrinsicOp::BINARY_BIT_XOR},
        {"binary_shift_left"sv, IntrinsicOp::BINARY_SHIFT_LEFT},
        {"binary_shift_right"sv, IntrinsicOp::BINARY_SHIFT_RIGHT},
        {"binary_rotate_left"sv, IntrinsicOp::BINARY_ROTATE_LEFT},
        {"binary_rotate_right"sv, IntrinsicOp::BINARY_ROTATE_RIGHT},
        {"binary_less"sv, IntrinsicOp::BINARY_LESS},
        {"binary_greater"sv, IntrinsicOp::BINARY_GREATER},
        {"binary_less_equal"sv, IntrinsicOp::BINARY_LESS_EQUAL},
        {"binary_greater_equal"sv, IntrinsicOp::BINARY_GREATER_EQUAL},
        {"binary_equal"sv, IntrinsicOp::BINARY_EQUAL},
        {"binary_not_equal"sv, IntrinsicOp::BINARY_NOT_EQUAL},
        {"all"sv, IntrinsicOp::ALL},
        {"any"sv, IntrinsicOp::ANY},
        {"select"sv, IntrinsicOp::SELECT},
        {"clamp"sv, IntrinsicOp::CLAMP},
        {"saturate"sv, IntrinsicOp::SATURATE},
        {"lerp"sv, IntrinsicOp::LERP},
        {"smoothstep"sv, IntrinsicOp::SMOOTHSTEP},
        {"step"sv, IntrinsicOp::STEP},
        {"abs"sv, IntrinsicOp::ABS},
        {"min"sv, IntrinsicOp::MIN},
        {"max"sv, IntrinsicOp::MAX},
        {"clz"sv, IntrinsicOp::CLZ},
        {"ctz"sv, IntrinsicOp::CTZ},
        {"popcount"sv, IntrinsicOp::POPCOUNT},
        {"reverse"sv, IntrinsicOp::REVERSE},
        {"isinf"sv, IntrinsicOp::ISINF},
        {"isnan"sv, IntrinsicOp::ISNAN},
        {"acos"sv, IntrinsicOp::ACOS},
        {"acosh"sv, IntrinsicOp::ACOSH},
        {"asin"sv, IntrinsicOp::ASIN},
        {"asinh"sv, IntrinsicOp::ASINH},
        {"atan"sv, IntrinsicOp::ATAN},
        {"atan2"sv, IntrinsicOp::ATAN2},
        {"atanh"sv, IntrinsicOp::ATANH},
        {"cos"sv, IntrinsicOp::COS},
        {"cosh"sv, IntrinsicOp::COSH},
        {"sin"sv, IntrinsicOp::SIN},
        {"sinh"sv, IntrinsicOp::SINH},
        {"tan"sv, IntrinsicOp::TAN},
        {"tanh"sv, IntrinsicOp::TANH},
        {"exp"sv, IntrinsicOp::EXP},
        {"exp2"sv, IntrinsicOp::EXP2},
        {"exp10"sv, IntrinsicOp::EXP10},
        {"log"sv, IntrinsicOp::LOG},
        {"log2"sv, IntrinsicOp::LOG2},
        {"log10"sv, IntrinsicOp::LOG10},
        {"pow"sv, IntrinsicOp::POW},
        {"pow_int"sv, IntrinsicOp::POW_INT},
        {"sqrt"sv, IntrinsicOp::SQRT},
        {"rsqrt"sv, IntrinsicOp::RSQRT},
        {"ceil"sv, IntrinsicOp::CEIL},
        {"floor"sv, IntrinsicOp::FLOOR},
        {"fract"sv, IntrinsicOp::FRACT},
        {"trunc"sv, IntrinsicOp::TRUNC},
        {"round"sv, IntrinsicOp::ROUND},
        {"rint"sv, IntrinsicOp::RINT},
        {"fma"sv, IntrinsicOp::FMA},
        {"copysign"sv, IntrinsicOp::COPYSIGN},
        {"cross"sv, IntrinsicOp::CROSS},
        {"dot"sv, IntrinsicOp::DOT},
        {"length"sv, IntrinsicOp::LENGTH},
        {"length_squared"sv, IntrinsicOp::LENGTH_SQUARED},
        {"normalize"sv, IntrinsicOp::NORMALIZE},
        {"faceforward"sv, IntrinsicOp::FACEFORWARD},
        {"reflect"sv, IntrinsicOp::REFLECT},
        {"reduce_sum"sv, IntrinsicOp::REDUCE_SUM},
        {"reduce_product"sv, IntrinsicOp::REDUCE_PRODUCT},
        {"reduce_min"sv, IntrinsicOp::REDUCE_MIN},
        {"reduce_max"sv, IntrinsicOp::REDUCE_MAX},
        {"outer_product"sv, IntrinsicOp::OUTER_PRODUCT},
        {"matrix_comp_neg"sv, IntrinsicOp::MATRIX_COMP_NEG},
        {"matrix_comp_add"sv, IntrinsicOp::MATRIX_COMP_ADD},
        {"matrix_comp_sub"sv, IntrinsicOp::MATRIX_COMP_SUB},
        {"matrix_comp_mul"sv, IntrinsicOp::MATRIX_COMP_MUL},
        {"matrix_comp_div"sv, IntrinsicOp::MATRIX_COMP_DIV},
        {"matrix_linalg_mul"sv, IntrinsicOp::MATRIX_LINALG_MUL},
        {"matrix_determinant"sv, IntrinsicOp::MATRIX_DETERMINANT},
        {"matrix_transpose"sv, IntrinsicOp::MATRIX_TRANSPOSE},
        {"matrix_inverse"sv, IntrinsicOp::MATRIX_INVERSE},
        {"aggregate"sv, IntrinsicOp::AGGREGATE},
        {"shuffle"sv, IntrinsicOp::SHUFFLE},
        {"insert"sv, IntrinsicOp::INSERT},
        {"extract"sv, IntrinsicOp::EXTRACT},
